...
#     rho_WVO = qt.tensor(rho_s_WVO, rho_u)
...
# plt.figure(1)
# plt.plot(C_array, T_espin_WVO, 'rv', label = 'WVO')
# plt.plot(C_array, T_espin_RIT, 'bo', label = 'RIT')
...
# txt3(T, p00_WVO, p00_RIT,'termalizacion_nokraus_prom_jy-1_1e4.txt')
